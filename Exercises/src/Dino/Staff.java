...
public class Staff {
    ...
    public Staff(String name, int age, String position, int yearsOfExperience) {
        this.name = name;
        this.age = age;
    ...
    static void addedStaff() {
        ...
        Staff zookeeper = new Staff("Spencer", 24, "zookeeper", 10);
        Staff veterinarian = new Staff("Brooke", 22, "veterinarian", 8);
        Staff dinoCaretaker = new Staff("Landon", 26, "dinosaur caretaker", 6);
        Staff tourGuide = new Staff("Jessie", 20, "tour guide", 3);
        Staff guestServiceAgent = new Staff("Chloe", 19, "Guest servie agent", 2);
        Staff intern = new Staff("Kyle", 18, "intern", 1);
