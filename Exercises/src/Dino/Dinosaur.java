...
public class Dinosaur {
    ...
    public Dinosaur(String name, String species, int age, String diet,
    ...
    public static void getRandomDino(DinosaurPark park) {
        Dinosaur randomDinosaur = park.getRandomDinosaur();
