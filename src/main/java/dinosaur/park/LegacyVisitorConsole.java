...
public class LegacyVisitorConsole {
    ...
    static void visitorGreeting() {
        ...
        LegacyParkConsole.amountOfVisitors();
    ...
    static void visitorOptions() {
        ...
        if(result == 1) {
            ...
            LegacyStaffConsole.addedStaff();
        }
        else if (result == 2) {
            System.out.println();
            // Retrieve a random dinosaur and display information
            DinosaurRegistry park = new DinosaurRegistry();
            park.initializeDinosaurs();
            ParkDinosaur.getRandomDino(park);
        }
        else if (result == 3) {
            System.out.println();
            // Get facts about a dinosaur species
            ParkDinosaur.speciesFacts();
        }
        else if (result == 4) {
            System.out.println();
            // Get the current date, time, or date & time
